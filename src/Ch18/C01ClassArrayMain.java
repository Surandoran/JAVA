...
//각 요소마다 객체생성이후 객체의 위치값을 저장을 해야 데이터를 저장하거나 기능을 사용할 수가 있다
...
public class C01ClassArrayMain {
    ...
    public static void main(String[] args) {
        ...
        //list[0].name = "홍길동";
        //list[0].addr = "대구";
        System.out.println("이름은 " + list[0].name + "사는곳은" + list[0].addr);


        list[1] = new C01Person("정우균","마산");
        //list[1].name = "정우균";
        //list[1].addr = "마산";
        System.out.println("이름은 " + list[1].name + "사는곳은" + list[1].addr);

        list[2] = new C01Person("이태수","울산");
        //list[2].name = "이태수";
        //list[2].addr = "울산";
        System.out.println("이름은 " + list[2].name + "사는곳은" + list[2].addr);
